...
parser.add_argument("--model_path", default="/home/ttmdawn/fjy_yan2/ToCo_yan2/My_work2/baseline_ptc_base/work_dir_voc_wseg/gongkai_wei/checkpoints/toco_vit-b_voc_20k.pth", type=str, help="model_path")
