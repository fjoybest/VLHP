...
sys.path.append(".")
sys.path.append("/home/ttmdawn/fjy_yan2/ToCo_yan2/My_work2/baseline_ptc_base/")
...
parser.add_argument("--model_path",
                    default="/home/ttmdawn/fjy_yan3/SAM_WSSS/baseline_ptc_clip/work_dir_voc_wseg/2025-05-15-07-01-11-526945/checkpoints/model_iter_20000.pth",
                    type=str, help="model_path")

parser.add_argument("--backbone", default='vit_base_patch16_224', type=str, help="vit_base_patch16_224")
parser.add_argument("--data_folder", default='/home/ttmdawn/fangjingyuan/data/VOCdevkit/VOC2012/', type=str,
                    help="dataset folder")
...
def _validate(model=None, data_loader=None, args=None):
    ...
    with torch.no_grad(), torch.cuda.device(0):
        ...
        for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
            ...
            inputs = F.interpolate(inputs, size=(r_h, r_w), mode='bilinear', align_corners=False)
