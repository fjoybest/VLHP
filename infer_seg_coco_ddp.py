...
parser.add_argument("--model_path", default="/home/ttmdawn/fjy_yan3/SAM_WSSS/baseline_ptc_clip/work_dir_coco_wseg/COCO-8-5-43/checkpoints/model_iter_80000.pth", type=str, help="model_path")
