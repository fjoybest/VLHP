...
parser.add_argument("--model_path", default="/home/ttmdawn/fjy_yan3/SAM_WSSS/baseline_ptc_clip/work_dir_voc_wseg/best_72.6/checkpoints/model_iter_18000.pth", type=str, help="model_path")
